...
export default function ChangePassword() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setFormSuccess(true);
      setFormMessage(result.message || "Password changed successfully.");
      ...
      setFormSuccess(false);
      setFormMessage(error.response?.data?.message || "Failed to change password. Please try again.");
            ...
            <div>
              ...
              <div className="relative mt-1">
                <input
                  ...
                  maxLength={6}
                  className={`w-full h-11 pl-3 rounded-md border outline-none
